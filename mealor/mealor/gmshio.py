...
if _has_gmsh:
    ...
    def extract_geometry(
        model: gmsh.model, name: str = None
    ...
    def model_to_mesh(
        model: gmsh.model, comm: _MPI.Comm, rank: int, gdim: int = 3
        ...
        if has_facet_data:
            ...
            print(marked_facets.shape)
            print(facet_values.shape)
            local_entities, local_values = _cpp.io.distribute_entity_data(
    ...
    def read_from_msh(
        filename: str, comm: _MPI.Comm, rank: int = 0, gdim: int = 3
    ) -> typing.Tuple[Mesh, _cpp.mesh.MeshTags_int32, _cpp.mesh.MeshTags_int32]:
